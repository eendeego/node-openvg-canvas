...
var Image = image.Image = function () {
  ...
  function setSource(data) {
    ...
    this.width_ = imgData.width;
    this.height_ = imgData.height;
    this.vgHandle_ = imgData.vgHandle;
    this.complete_ = true;
  }
