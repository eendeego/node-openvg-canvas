...
Gradient.prototype.stopArray = function (alpha) {
  ...
  return stopArray.subarray(0, this.stopCount * 5);
};
...
Gradient.prototype.parameterArray = function () {
  ...
  return parameterArray.subarray(0, this.parameters.length);
};
...
Gradient.prototype.configurePaint = function (paint, alpha) {
  ...
  vg.setParameterFV(paint, paintParam, this.parameterArray());
