...
var knownFamilies = {
  ...
  'sans-bold' : '/usr/share/fonts/truetype/ttf-dejavu/DejaVuSans-Bold.ttf',
...
var loadTypeface = text.loadTypeface = function(font, callback) {
  ...
  if (!filename) {
    filename = knownFamilies['sans'];
  }

  return font.typeface = loading.loadFontFileSync(filename, callback);
};
