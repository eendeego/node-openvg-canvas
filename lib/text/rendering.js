...
var renderText = rendering.renderText = function(x, y, text, font, lineWidth, pointSize, paintMode) {
  ...
  if (textBaselineOffset) {
    mat[7] += textBaselineOffset(font.ascender  * pointSize / 65536.0,
                                 font.descender * pointSize / 65536.0);
  }
  ...
  for (var i = 0; i < text.length; i++) {
    ...
    mat[6] += size * font.glyphAdvances[glyph] / 65536.0;
  }
