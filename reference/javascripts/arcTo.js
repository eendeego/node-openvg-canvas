...
(function (exports) {
  ...
  var Painter = exports.Painter = function (canvas, options) {
    ...
    var strangeEllipse = function (x, y, radiusX, radiusY, rotation, startAngle, endAngle, anticlockwise) {
      ctx.save();
      ...
      ctx.moveTo(Math.cos(startAngle), Math.sin(startAngle));
    ...
    function arcDraft(p1, p2, p3, radiusX, radiusY, rotation) {
      ...
      if (cross_prod !== 0) {
        ...
        strangeEllipse(center.x, center.y, radiusX, radiusY, rotation, 0, 2 * Math.PI, true);
        ctx.stroke();
        ...
        strangeEllipse(center.x, center.y,
      ...
      function dot(p) {
        ...
        ctx.arc(p.x, p.y, rc, 0, 2 * Math.PI, true);
      }
    ...
    function getRadiusX() { return radiusX; }
    function setRadiusX(r) { radiusX = r; }
    function getRadiusY() { return radiusY; }
    function setRadiusY(r) { radiusY = r; }
    function getRotation() { return rotation; }
    function setRotation(r) { rotation = r; }

    Object.defineProperty(this, 'radiusX', { enumerable: true, get: getRadiusX, set: setRadiusX });
    Object.defineProperty(this, 'radiusY', { enumerable: true, get: getRadiusY, set: setRadiusY });
    Object.defineProperty(this, 'rotation', { enumerable: true, get: getRotation, set: setRotation });

    this.paint = function (now) {
      ctx.fillStyle = 'black';
...
})(typeof exports === 'undefined' ? this['arcTo'] = {} : exports);
