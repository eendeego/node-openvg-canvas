...
ctx.fillRect(x, y, 128, 128); // This rect should be partially visible
ctx.globalAlpha = 0.5;
...
x += 64;
ctx.globalAlpha = 0.7;
ctx.drawImage(img, 32, 32, 64, 64, x, y, 256, 256); // This should be partially visible
ctx.globalAlpha = 1;
...
eu.saveScreenshot(ctx, 0, 0, 1024, 768,
                  'examples/screenshots/drawImageAlpha.png');
